...
function lapinopay_get_payment_icon($icon_name, $alt_text)
{
    ...
    $svg_icons = array(
        ...
        'credit-card' => '<svg width="133" height="33" viewBox="0 0 133 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
            <linearGradient id="paint0_linear_3383_3096" x1="3403.19" y1="76.177" x2="3472.38" y2="-2378.8" gradientUnits="userSpaceOnUse">
            <stop stop-color="#222357"/>
            <stop offset="1" stop-color="#254AA5"/>
            </linearGradient>
            <clipPath id="clip0_3383_3096">
            <rect width="74.03" height="24" fill="white" transform="translate(0 4.32129)"/>
            </clipPath>
            <clipPath id="clip1_3383_3096">
            <rect width="42" height="32.6425" fill="white" transform="translate(90.0312)"/>
            </clipPath>
            </defs>
            </svg>
            ',
